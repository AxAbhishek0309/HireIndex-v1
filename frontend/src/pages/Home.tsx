...
const Home: React.FC = () => {
  return (
    <div>
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-blue-600 to-indigo-700 dark:from-gray-900 dark:to-gray-950 text-white py-16">
            ...
            <div className="md:w-1/2 mb-10 md:mb-0">
              ...
              <div className="flex flex-wrap gap-4">
                <Link href="/resume-analyzer">
                  <Button className="bg-white text-blue-600 hover:bg-blue-50 dark:bg-gray-100 dark:text-blue-700 font-medium text-lg px-6 py-3">
                    Analyze My Resume
                  </Button>
                </Link>
                <Button variant="outline" className="border-white text-white hover:bg-blue-700 dark:border-gray-300 dark:text-gray-100 font-medium text-lg px-6 py-3">
                  Learn More
                </Button>
              </div>
            </div>
            <div className="md:w-1/2 flex justify-center">
              <div className="bg-white/10 dark:bg-gray-900/80 p-6 rounded-lg backdrop-blur-sm border border-white/20 dark:border-gray-800 max-w-md">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100 dark:text-gray-300">Score higher on applicant tracking systems</p>
                  </div>
                </div>
                <div className="bg-white/20 dark:bg-gray-800 h-2 rounded-full mb-6">
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-950">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 text-gray-900 dark:text-gray-100">How Our ATS Resume Analyzer Works</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-800">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-gray-100">AI Analysis</h3>
              <p className="text-gray-600 dark:text-gray-300">
            ...
            <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-800">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-gray-100">Get Detailed Results</h3>
              <p className="text-gray-600 dark:text-gray-300">
      ...
      <section className="py-16 bg-blue-50 dark:bg-gray-900">
        <div className="container mx-auto px-4">
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-md p-8 max-w-4xl mx-auto border border-gray-200 dark:border-gray-800">
            <div className="flex flex-col md:flex-row md:items-center">
              <div className="md:w-2/3 mb-6 md:mb-0">
                <h2 className="text-2xl font-bold mb-2 text-gray-900 dark:text-gray-100">Ready to improve your resume?</h2>
                <p className="text-gray-600 dark:text-gray-300">
              ...
              <div className="md:w-1/3 flex justify-center md:justify-end">
                <Link href="/resume-analyzer">
                  <Button className="bg-blue-600 hover:bg-blue-700 text-white font-medium px-6 py-3 dark:bg-blue-700 dark:hover:bg-blue-800">
      ...
      <section className="py-16 dark:bg-gray-950">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 text-gray-900 dark:text-gray-100">What Our Users Say</h2>
            <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-800">
              ...
              <div className="font-medium text-gray-900 dark:text-gray-100">Michael T., Software Engineer</div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-800">
              ...
              <div className="font-medium text-gray-900 dark:text-gray-100">Sarah K., Marketing Specialist</div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-800">
              ...
              <div className="font-medium text-gray-900 dark:text-gray-100">David L., Project Manager</div>
            </div>
          </div>
        </div>
      </section>
